...
# Author: Carlos Paulino <chgp@riseup.net> revision 0.5 2008/03/09
...
say section_gui "Interface"
  ...
  say -font "especificar o tamanho da fonte em pontos"

say section_other "Outros"
  say -open "abrir arquivo(s) na inicialização"
  say -verbose "exibir mais detalhes na carga do programa e quando pesquisar por arquivos"
...
say do_what_i_mean "Realize o que estou pensando!"
say ask_cool "Você vai ficar louco quando este recurso for implementado."
...
say snap_grid "Posicionar na Grade"
